...
function [kVIS_prefs] = kVIS_preferences()
% kVIS Preferences Template
%
% Rename to kVIS_preferences.m and save so it will be used.
...
%% SIDPAC PATH
kVIS_prefs.sidpac_path = '/Users/kai/Dbox/_Flight_Research/Toolboxes/SIDPAC_V2.0_SI';

%% External Board Support Packages (BSPs)
kVIS_prefs.bsp_dir = '/Users/kai/developer/kVIS3_bsp_ardupilot';
% kVIS_prefs.bsp_dir = '/Users/kai/developer/KSID_bsp_uavmainframe';
