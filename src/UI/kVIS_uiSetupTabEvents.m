...
uicontrol(rbn_event_pane, 'Style', 'pushbutton',...
    ...
    'Callback',@kVIS_eventExport_Callback);

uicontrol(rbn_event_pane, 'Style', 'pushbutton',...
    'CData',imread('icons8-exportBatch-36.png'),...
    'TooltipString','Export Event(s) for all FDS files',...
    'Callback',@kVIS_eventExportBatch_Callback);
