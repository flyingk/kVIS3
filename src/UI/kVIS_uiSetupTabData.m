...
data_tab_left = uix.VBox('Parent',data_tab_hbox,'Backgroundcolor',handles.preferences.uiBackgroundColour,'Padding',8);
data_tab_right = uix.VBox('Parent', data_tab_hbox,'Backgroundcolor',handles.preferences.uiBackgroundColour,'Padding',8);
...
uicontrol(data_tab_left,'Style','text',...
    ...
    'Units','normalized',...
    'Backgroundcolor',handles.preferences.uiBackgroundColour, 'Foregroundcolor','w','FontSize',16);
...
handles.uiTabData.groupTree = uiw.widget.Tree( ...
    ...
    'FontUnits', 'points',...
    'FontName', 'Monospaced', ...
    'FontSize', handles.preferences.defaultGroupTreeFontSize, ...
    'RootVisible', false ,...
...
search_bar_field = uix.HBox('Parent', data_tab_right,'Backgroundcolor', handles.preferences.uiBackgroundColour, 'Padding', 1);
