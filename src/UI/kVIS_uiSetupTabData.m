...
handles.uiTabData.dataSetList = uicontrol(data_tab_left,...
    'Style', 'listbox', ...
    'Units', 'normalized', ...
...
uix.Empty('Parent', data_tab_left);

search_bar_field = uix.HBox('Parent', data_tab_left,'Backgroundcolor', getpref('kVIS_prefs','uiBackgroundColour'), 'Padding', 1);

data_tab_left.Heights = [20 -1 20 -4 20 -4 3 20];
