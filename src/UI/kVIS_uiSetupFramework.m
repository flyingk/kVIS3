...
%
set(appWindow,'name',['kVIS3 2022.5 fds2 - BSP: ' BSP_Info.Name ' build ' BSP_Info.Version]);
...
handles = kVIS_uiSetupTabWaypoints(handles, handles.uiFramework.uiTabGroupRight);
%% left hand tabs
% built-in:
