...
uicontrol( ...
    ctrls, ...
    'Style', 'pushbutton', ...
    'String', 'Saveable Version', ...
    'Callback', {@kVIS_generateCustomPlotXLS_saveable, fds, plotName, lims, Style, fds_name, idxFdsCurrent, false, eventToggle} ...
);
