...
uiDataRangeGrid = uix.Grid('Parent',uiPanelDataRange,'Backgroundcolor',...
     getpref('kVIS_prefs','uiBackgroundColour'),'Spacing',4,'Padding',2);
...
uicontrol(uiDataRangeGrid,'Style','text',...
    ...
    'Foregroundcolor','w','FontSize',14, 'HorizontalAlignment', 'left');

% X
lbl = uicontrol(uiDataRangeGrid,'Style','text',...
